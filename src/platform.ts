...
import {HEALTH_VERSION, PIHOLE_VERSION, PLATFORM_NAME, PLUGIN_NAME, VENTILATION_VERSION} from './settings';
...
import {PiHoleAccessory} from './PiHoleAccessory';
...
export class HealthBoxHomebridgePlatform implements DynamicPlatformPlugin {
  ...
  private addPiHole() {
    ...
    if (existingAccessory) {
      ...
      new PiHoleAccessory(this, accessory);
